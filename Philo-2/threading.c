...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/12/11 13:45:32 by helmouta          #+#    #+#             */
/*   Updated: 2025/12/11 17:42:37 by helmouta         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	*is_dead(void *arg)
{
	...
	if (!monitor_death(philo, 0) && !philo->is_fnished && (get_time() - philo->last_meal) >= (long int)philo->args->time_to_die)
	{
